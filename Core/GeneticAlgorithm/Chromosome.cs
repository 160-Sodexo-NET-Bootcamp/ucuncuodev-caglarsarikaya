    ...
    public class Chromosome
    {
        ...
        public Chromosome(City[] cities)
        {
            ...
            for (int i = 0; i < cityList.Length - 1; i++)
            {
                ...
                {
                    icandidate =
                        (int)(randObj.NextDouble() * (double)cityList.Length);
                }
        ...
        public void calculateCost(City[] cities)
        {
            ...
            {
                double dist =
                    cities[cityList[i]].proximity(cities[cityList[i + 1]]);
                cost += dist;
            }
        }
        ...
        public int
        mate(Chromosome father, Chromosome offspring1, Chromosome offspring2)
        {
            int crossoverPostion1 =
                (
                int
                )((randObj.NextDouble()) *
                (double)(cityList.Length - crossoverPoint));
        ...
        {
             Console.WriteLine("City " +  i.ToString() +  ": (" + cities[cityList[i]].getx().ToString() +  ", " + cities[cityList[i]].gety().ToString() +  ")");
        }
